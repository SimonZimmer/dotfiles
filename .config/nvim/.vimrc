" requirements:
" nvim nightly, neovim python module, ccls ,ripgrep
...
augroup my-glyph-palette
  autocmd! *
  autocmd FileType c,cpp,objc,objcpp,python call glyph_palette#apply()
augroup END
...
" jump to next issue
nmap <silent><nowait> gn :call CocAction('diagnosticNext')<cr>
nmap <silent><nowait> gN :call CocAction('diagnosticPrevious')<cr>
